...
protected:
    ...
    */
    KMultiTabBarButton(const QPixmap& pic, const QString&, const QString &, int id, QWidget *parent);
private:
...
private:
     ...
     */
    KMultiTabBarTab(const QPixmap& pic, const QString&, const QString & desc, int id, QWidget *parent,
...
public:
	...
	int appendTab(const QPixmap &pic,int id=-1,const QString& text=
			QString(), const QString & desc = QString());
