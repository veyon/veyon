/*
 * MacOsInputDeviceFunctions.h - declaration of LinuxInputDeviceFunctions class
 *
...
class MacOsKeyboardInput;

// clazy:excludeall=copyable-polymorphic

class MacOsInputDeviceFunctions : public PlatformInputDeviceFunctions
{
public:
	MacOsInputDeviceFunctions() = default;
	~MacOsInputDeviceFunctions() override;
