...
class MacOsKeyboardShortcutTrapper : public KeyboardShortcutTrapper
{
	Q_OBJECT
public:
	explicit MacOsKeyboardShortcutTrapper( QObject* parent = nullptr ) :
	    KeyboardShortcutTrapper( parent )
	{
	}

	~MacOsKeyboardShortcutTrapper() override = default;
