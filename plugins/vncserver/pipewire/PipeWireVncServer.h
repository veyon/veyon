/*
 * PipeWireVncServer.h - declaration of PipeWireVncServer class
 *
...
private:
	static constexpr auto UpdateTime = 10;
	static constexpr auto IdleSleepTime = 100;

	bool initVncServer( int serverPort, const VncServerPluginInterface::Password& password, PipeWireScreen* screen );

	bool initScreen( PipeWireScreen* screen );
	void handleScreenChanges( PipeWireScreen* screen );

	bool clientUpdateRequestsPending( const PipeWireScreen* screen ) const;
