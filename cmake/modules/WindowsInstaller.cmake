set(WINDOWS_INSTALL_FILES "insight-teacher-${VEYON_WINDOWS_ARCH}-${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_PATCH}.${VERSION_BUILD}")
...
add_custom_target(windows-binaries
	...
	COMMAND cp ${DLLDIR}/libsasl*.dll ${WINDOWS_INSTALL_FILES} || true
	COMMAND cp ${DLLDIR}/libldap*.dll ${DLLDIR}/liblber*.dll ${WINDOWS_INSTALL_FILES} || true
	...
	COMMAND cp -ra ${CMAKE_SOURCE_DIR}/default-keys ${WINDOWS_INSTALL_FILES}
...
add_custom_target(create-windows-installer
	...
	COMMAND mv ${WINDOWS_INSTALL_FILES}/*setup.exe .
	COMMAND rm -rf ${WINDOWS_INSTALL_FILES}
