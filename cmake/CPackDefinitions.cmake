...
if(OS_OPENSUSE)
	if(WITH_QT6)
		set(CPACK_RPM_PACKAGE_REQUIRES ${CPACK_RPM_PACKAGE_REQUIRES} "qca-qt6-plugins, libQt6QuickControls2-6")
	else()
		set(CPACK_RPM_PACKAGE_REQUIRES ${CPACK_RPM_PACKAGE_REQUIRES} "libqca-qt5-plugins, libqt5-qtquickcontrols2")
	endif()
else()
	if(WITH_QT6)
		set(CPACK_RPM_PACKAGE_REQUIRES ${CPACK_RPM_PACKAGE_REQUIRES} "qca-qt6-ossl, qt6-qtdeclarative")
	else()
