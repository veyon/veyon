...
void ComputerMonitoringView::setComputerManager(ComputerManager &manager)
{
	delete m_computerListModel;

	m_computerListModel = new ComputerListModel( manager, this );
